...
Account all_accounts[100];
    ...
    while(input != 'q')
    {
        ...
        cout << endl << "What would you like to do today?" << endl << "C - Create Event" << endl << "R - Review Event" << endl << "O - log out" << "V - View Most Recent Event" << endl << "q - Quit" << endl << endl;
        ...
        if(input == 'C' || input == 'c')
        {
            ...
            cout << "Enter the location of the event: (words separated by an underscore)" << endl;
            cin >> location;
        ...
        {
            cout << endl;
            for(int i = 0; i < num_cals - 1; i++)
            {
                all_calendars[i].display();
                /*
...
int main()
{
    ...
    Calendar_with_Weather running_application;
    running_application.Run_Application();
    return 0;
}